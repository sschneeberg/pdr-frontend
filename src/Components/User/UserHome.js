    ...
    render() {
        const pageDisplay = () => {
            if (this.state.notification) {
                return (
                    <div>
                        <div aria-live="polite" aria-atomic="true" style={{position: "relative", minHeight: "100px", minWidth: "100px", border: "solid 2px black"}}>
                        ...
                        <button type="button" className="ml-2 mb-1 close" onClick={this.resetNote} data-dismiss="toast" aria-label="Close">
